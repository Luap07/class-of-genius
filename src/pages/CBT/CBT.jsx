        ...
        <section className="pt-14 sm:pt-20 lg:pt-24">
          <div className="mx-auto max-w-4xl text-center">
            ...
            >
              ...
              <span>
                Scholiqen Computer-Based Testing
              </span>
            </motion.div>
            ...
            >
              Prepare smarter with structured computer-based
              practice, exam-style questions, timed sessions,
              and detailed performance tracking across major
              examination bodies.
            </motion.p>
          ...
          <div className="relative">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-400">
                Train under realistic CBT conditions,
                improve your speed, strengthen weak
