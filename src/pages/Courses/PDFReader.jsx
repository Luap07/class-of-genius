...
id
? `${API_BASE_URL}/api/academy/student/materials/${encodeURIComponent(
          String(id)
        )}`
: null;
...
false
      ...
      setPdfError(
        new Error(
          "This material does not have a valid PDF file."
        )
      );
...
return ( <div className="flex min-h-screen items-center justify-center bg-[#02040a] text-white"> <div className="text-center"> <Loader2
         size={42}
...
return ( <div className="flex min-h-screen items-center justify-center bg-[#02040a] px-6 text-white"> <div className="w-full max-w-lg rounded-[32px] border border-slate-800 bg-slate-900/80 p-8 text-center shadow-2xl backdrop-blur-xl">
...
return ( <div className="flex min-h-screen items-center justify-center bg-[#02040a] px-6 text-white"> <div className="w-full max-w-md rounded-[32px] border border-red-500/20 bg-slate-900/80 p-8 text-center shadow-2xl backdrop-blur-xl">
...
return ( <div className="flex min-h-screen items-center justify-center bg-[#02040a] px-6 text-white"> <div className="w-full max-w-lg rounded-[32px] border border-red-500/20 bg-slate-900/80 p-8 text-center shadow-2xl backdrop-blur-xl">
      <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-3xl bg-red-500/10">
        <AlertCircle
          size={40}
          className="text-red-400"
