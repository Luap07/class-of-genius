      ...
      >
        ...
        <div
          className="
            absolute
            inset-0
            bg-[radial-gradient(circle_at_top_right,rgba(59,130,246,.18),transparent_45%),radial-gradient(circle_at_bottom_left,rgba(6,182,212,.12),transparent_45%)]
          "
        />
        ...
        >
          ...
          >
            ...
            >
              ...
              Discover languages from around the world,
              improve your communication skills,
              practice pronunciation,
              build vocabulary,
              and master new cultures through
  ...
  onClick={() => navigate(`/languages/${language.id}`)}
          ...
          >
            ...
            <p
              ...
              "
            >
              We couldn't find any language matching
