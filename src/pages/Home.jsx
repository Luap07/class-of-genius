  ...
  return (
    <div className="min-h-screen bg-white relative">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-12 lg:px-24 pt-28 pb-16">
          ...
          {/* STATS */}
          <div className="grid grid-cols-3 gap-6 bg-white/40 backdrop-blur-md p-8 rounded-3xl border">
            <div>
